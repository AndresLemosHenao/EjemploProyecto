...
public class ProveedoresController implements Serializable {
    ...
    @EJB
    private com.ejemplo.session.ProveedoresFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ProveedoresCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ProveedoresUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ProveedoresDeleted"));
        if (!JsfUtil.isValidationFailed()) {
