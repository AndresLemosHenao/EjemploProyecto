...
import com.ejemplo.entities.Dependencias;
import com.ejemplo.jsf.util.JsfUtil;
import com.ejemplo.jsf.util.JsfUtil.PersistAction;
import com.ejemplo.session.DependenciasFacade;
...
@ManagedBean(name = "dependenciasController")
@SessionScoped
public class DependenciasController implements Serializable {

    @EJB
    private com.ejemplo.session.DependenciasFacade ejbFacade;
    ...
    public static class DependenciasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Dependencias) {
                ...
                return getStringKey(o.getIdDependencias());
            } else {
