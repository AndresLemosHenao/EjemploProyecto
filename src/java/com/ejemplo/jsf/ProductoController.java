...
import com.ejemplo.session.ProductoFacade;
...
public class ProductoController implements Serializable {
    ...
    @EJB
    private com.ejemplo.session.ProductoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ProductoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ProductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ProductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
