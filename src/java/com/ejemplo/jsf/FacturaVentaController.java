...
import com.ejemplo.session.FacturaVentaFacade;
...
public class FacturaVentaController implements Serializable {
    ...
    @EJB
    private com.ejemplo.session.FacturaVentaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("FacturaVentaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("FacturaVentaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("FacturaVentaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
